...
export const museumPiecesExtension = {
  ...
  "winged-victory-of-samothrace": {
    kind: "sketchfab",
    path: "/winged-victory-of-samothrace/",
    sectionId: "hellenistic-world",
    sortOrder: 26,
    viewerTitle: "Winged Victory of Samothrace (c. 200-175 BCE)",
    subtitle: "Artist: Unknown Hellenistic sculptor",
    medium: "Parian marble (statue), Lartian marble (ship and base)",
    dimensions: "H. 564 cm total; H. 328 cm statue; W. 258 cm ship; D. 467 cm base",
    locationLabel: "On view:",
    location: "Denon, Salle 703 - Palier Samothrace, Salle 703 - Niveau superieur est, Musee du Louvre",
    culture: "Hellenistic Greek",
    region: "Greek world",
    period: "Hellenistic, first quarter of the 2nd century BCE",
    current_location: "Denon, Salle 703 - Palier Samothrace, Salle 703 - Niveau superieur est, Musee du Louvre",
    findspot_or_origin: "Rhodes (?)",
    scan_source: "Sketchfab",
    mesh_format: "Sketchfab embed",
    tags: ["Louvre", "Hellenistic", "Greek", "Marble", "Nike", "Samothrace"],
    lobbyMeta: "Source: Sketchfab / Louvre metadata",
    source: source(
      "Viewer currently uses a published Sketchfab model, while the title, date, material, dimensions, and current Louvre room location follow the Louvre collection record for the Victory of Samothrace.",
      [
        link("Louvre collection record", "https://collections.louvre.fr/en/ark:/53355/cl010252531"),
        link("Sketchfab model", "https://sketchfab.com/3d-models/winged-victory-of-samothrace-4edd6459f2834e7ab0b395e71cee2513")
      ],
      "The published Sketchfab model is listed under CC BY 4.0."
    ),
    defaults: {
      zoom: 2.3,
      lightAngle: 22,
    ...
    model: {
      uid: "4edd6459f2834e7ab0b395e71cee2513",
      triangles: 283134,
      sourceBytes: 11464604
    }
  },
  "seated-scribe": {
    kind: "sketchfab",
    ...
    sectionId: "egypt-mesopotamia",
    sortOrder: 13,
    viewerTitle: "The Seated Scribe (Fifth Dynasty, c. 2545-2413 BCE)",
    subtitle: "Artist: Unknown Egyptian sculptor",
    medium: "Limestone with paint",
    dimensions: "H. 58 x W. 35 x D. 33 cm",
    locationLabel: "On view:",
    location: "Sully, Salle 335 - L'ecriture et les scribes, Vitrine 1, Musee du Louvre",
    culture: "Ancient Egyptian",
    region: "Egypt",
    period: "Fifth Dynasty (style attribution)",
    current_location: "Sully, Salle 335 - L'ecriture et les scribes, Vitrine 1, Musee du Louvre",
    scan_source: "Sketchfab",
    mesh_format: "Sketchfab embed",
    tags: ["Louvre", "Egyptian", "Limestone", "Painted sculpture", "Scribe"],
    lobbyMeta: "Source: Sketchfab / Louvre metadata",
    source: source(
      "Viewer currently uses a published Sketchfab model, while the title, date, material, dimensions, and current Louvre room location follow the Louvre collection record for the seated scribe.",
      [
        link("Louvre collection record", "https://collections.louvre.fr/en/ark:/53355/cl010009497"),
        link("Sketchfab model", "https://sketchfab.com/3d-models/the-seated-scribe-le-scribe-accroupi-8fb85585fa4444fd91bf746391d5e7cb")
      ],
      "The published Sketchfab model is listed under CC BY-NC-SA 4.0."
    ),
    defaults: {
      zoom: 1.95,
      lightAngle: 18,
    ...
    model: {
      uid: "8fb85585fa4444fd91bf746391d5e7cb",
      triangles: 77674,
      sourceBytes: 5180405
    }
  },
